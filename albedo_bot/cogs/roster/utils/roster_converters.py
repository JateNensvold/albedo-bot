        ...
        try:
            try:
                ...
                if len(hero_instances_result) == 1:
                    ...
                    hero_instance_select = self.select(Hero).where(
